...
* `docs/spec-tutorial.md` is a practical guide to model attacker/victim specs in TestDL
...
To define new attacker/victim models without touching OCaml internals, see:

- `docs/spec-tutorial.md`
- `docs/testdl-action-reference.md`
- `docs/spec-extending-actions.md`

It documents TestDL syntax for attacker capabilities and enclave behavior, plus pointers to reusable specs in `spec-lib/`.
