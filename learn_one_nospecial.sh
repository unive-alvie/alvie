...
# Learn models for a specific attacker spec (no special intermediate commit).
#
# Usage:
#   ./learn_one_nospecial.sh <att_spec> <subdirectory> [--fpga]
#
...
TMP_DIR=$SCRIPT_DIR/tmp/$2${DIR_SUFFIX}

SCG_DIR=$SCRIPT_DIR/sancus-core-gap
SPEC_DIR=$SCRIPT_DIR/spec-lib/$2
